...
## Build the model
"""
efficient_net = EfficientNetB0(input_shape=(112,112,3), include_top=False, weights='imagenet', pooling='max')
...
second_model.fit(X_train, Y_train, batch_size=batch_size , epochs=epochs , validation_data = (X_test, Y_test), class_weight= class_weights )

"""
## Evaluate the trained model
"""

score = second_model.evaluate(X_test, Y_test, verbose=0)
print("Test loss:", score[0])
print("Test accuracy:", score[1])

model.save_weights('weights/efficientnet.hdf5')
